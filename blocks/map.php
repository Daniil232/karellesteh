<div class="map_block" style="position: relative;">
	<div class="map-api">
	...
	<div class="container">
		<div class="row">
			<div class="map-info text-center" style="width: 400px;position: absolute; top: 0;background: black; height:100%; opacity: 0.69;">
				<div class="map-header">
					<div class="map-info-text">
						<h4>Петрозаводск</h4>
						<p>Республика Карелия,<br> г. Петрозаводск,<br> р-н Томицы</p>
					</div>
				</div>

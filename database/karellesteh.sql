...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 14 2023 г., 00:58
...
CREATE TABLE `news` (
  ...
  `mainImg` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `additionImg` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
CREATE TABLE `products` (
  ...
  `nameProduct` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `acceptability` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `img` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `additionalImg` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `alt` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `code` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `vendorCode` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `addition` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `price` int NOT NULL,
...
INSERT INTO `services` (`id`, `number`, `name`) VALUES
(5, '1', 'Оценка стоимости (независимая) лесозаготовительной техники (харвестров, форвардеров, харвестеров на базе экаваторов)'),
(6, '2', 'Капитальный ремонт, предпродажная подготовка Л/З техники'),
(7, ' ~  2.1', 'Ремонт ходовой части'),
(8, '~  2.2', 'Ремонт манипуляторов'),
(9, ' ~  2.3', 'Ремонт двигателей'),
(10, ' ~  2.4', 'Ремонт гидравлических систем'),
(11, ' ~  2.5', 'Ремонт тормозных систем'),
(12, ' ~  2.6', 'Ремонт, диагностика электрических систем'),
(13, ' ~  2.7', 'Покраска Л/З техники'),
(14, ' ~  2.8', 'Замена агрегатов и запасных частей'),
(15, '3', 'Проведение ТО (плановое), межсезонное'),
(16, '4', 'Продажа Л/З техники, запчастей, агрегатов'),
(17, '5', 'Прием на комиссию Л/З техники, агрегатов, запасных частей, оборудования сопуствующего лесозаготовки');
...
--
ALTER TABLE `news`
  MODIFY `idNew` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
